...
df1 = pd.read_csv(r"FrenchDataTrain1.txt",quoting=csv.QUOTE_NONE, encoding="UTF-8", sep = "\t", error_bad_lines=False).fillna(method="ffill")
...
import pandas as pd
df1 = pd.read_csv("TaggedQueriesFrench.txt", encoding="UTF-8", sep = "\n").fillna(method="ffill")
...
nofrenchquery = 0
nomapping = 0
f1 = "WrongTrainFrench.txt"
f2 = "RightTrainFrench.txt"
while i<len(dat1):
