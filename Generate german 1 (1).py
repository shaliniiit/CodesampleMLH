...
df1 = pd.read_csv(r"GermanDataTrain1.txt",quoting=csv.QUOTE_NONE, encoding="UTF-8", sep = "\t", error_bad_lines=False).fillna(method="ffill")
...
import pandas as pd
df1 = pd.read_csv("TaggedQueriesGerman.txt", encoding="UTF-8", sep = "\n").fillna(method="ffill")
...
nofrenchquery = 0
nomapping = 0
f1 = "WrongTrainGerman.txt"
f2 = "RightTrainGerman.txt"
while i<len(dat1):
